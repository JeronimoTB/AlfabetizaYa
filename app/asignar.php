...
?>
  ...
  * License: https://bootstrapmade.com/license/
    ...
    <body>
        <header id="header" class="fixed-top " style="opacity: 1;">
            <div class="container d-flex align-items-center">
                ...
                <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        <li><a href="admins.html">Sitio </a></li>
        ...
        <form method="post" action="###" class="form-register" id="registro">
            ...
            <input class="controls" type="text" name="lugar" id="lugar" placeholder="Ingrese el Lugar de Servicio">

            <label class="font-weight-bold"> Fecha de asignación <span class="text-danger">*</span></label>
            <input class="controls" type="date" name="fecha" id="fecha" placeholder="Ingrese la Fecha">

            <label class="font-weight-bold"> Numero de Carnet <span class="text-danger">*</span></label>
            <input class="controls" type="number" min="1" max="3000" name="soli" id="soli" placeholder="Ingrese el numero de Solicitud">

            <label class="font-weight-bold"> Horas de Servicio <span class="text-danger">*</span></label>
            <input class="controls" type="text" maxlength="11" name="cedu" id="cedu" placeholder="Ingrese su Cédula">
            <input class="botons" type="submit" value="Registrar">
            <p><a href="#">¿Deseas actualizar horas?</a></p>
        </form>
        <br>
        <br>
